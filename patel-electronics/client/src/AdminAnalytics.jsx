      ...
      <nav className="pm-nav">
        <div className="pm-nav-content">
          ...
          <div className="pm-nav-menu">
            ...
            <Link to="/admin/analytics" className="pm-nav-link pm-nav-active">
              <span className="pm-nav-icon">📊</span>
              Analytics
            </Link>
          </div>
      ...
      <header className="pm-header">
        <div className="pm-header-content">
          <div className="pm-title">
            <h1>Analytics</h1>
            <p>View sales trends and store statistics.</p>
          </div>
        </div>
      </header>
      ...
      <div className="pm-main-content" style={{ marginTop: '2rem' }}>
        <div className="pm-card">
          <div className="pm-card-content">
            <h2>Sales & Traffic</h2>
            <p style={{ marginTop: '1rem', color: '#64748b' }}>Full analytics dashboard is under construction.</p>
          </div>
        </div>
      </div>
